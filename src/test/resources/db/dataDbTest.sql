...
VALUES (CAST('2dd4c08c-50cd-444b-a75c-4e86001e8bbf' as binary(16)), 'Student',
        '$2a$10$5GOSARIOZ23c04ORlvXSrODJj/v9tsk63HfMhS.3/r5Rfpq/3Xm8G', 'Kikosin34@gmail.com',
        '4600906895214405', '+1234567890', 0000.00),
       (CAST('963e3e81-1983-4ea8-8ab5-2e0ff0919727' as binary(16)), 'User',
        '$2a$10$5GOSARIOZ23c04ORlvXSrODJj/v9tsk63HfMhS.3/r5Rfpq/3Xm8G', 'Kikosina34@gmail.com',
        '4600906895264405', '+1234567890', 0000.00),
       (CAST('e2d3ab6d-734d-4140-a399-17b41640e190' as binary(16)), 'Admin',
        '$2a$10$lfRhINsfChs9Fpe/B1.dXOphzztYWMdiYlIia23sipcmJv5F60rqy', 'LENA2@meta.ua',
        '377457426914898', '+0987654321', 2500.00),
       (CAST('a14dc00b-e97f-4ef7-bbb3-bfcbc074a9de' as binary(16)), 'Teacher',
        '$2a$10$D1..3IlaaPoZgd36XVPyz.N8z0NGs3VEyFrWu0Kor.XqQQCkJ3BiC', 'Kolya3@example.com',
...
VALUES (CAST('2dd4c08c-50cd-444b-a75c-4e86001e8bbf' as binary(16)),
       ...
       (CAST('e2d3ab6d-734d-4140-a399-17b41640e190' as binary(16)),
        CAST('6e01b191-453c-4464-998f-a671619e89de' as binary(16))),
       (CAST('963e3e81-1983-4ea8-8ab5-2e0ff0919727' as binary(16)),
        CAST('c89a7f93-6f32-400e-847c-c229a3971579' as binary(16))),
...
VALUES (CAST('7a4a0dc7-371a-481f-a967-d4455151a4a0' as binary(16)),
        'Ukraina, Uman, str. Bogdana Chornomaza 5, 20300', false, 'https://www.school11.org.ua',
        'Uman Gymnasium No. 11',
...
VALUES (CAST('d234d99d-170e-42f7-b6ae-435ee56f49b5' as binary(16)), 'Kira', 'Mikiz', '1993-10-25',
       ...
       (CAST('14a59ac9-8681-432b-a770-7893b52b6e6e' as binary(16)), 'Lena', 'Grynik', '1993-01-05', NULL,
        CAST('e2d3ab6d-734d-4140-a399-17b41640e190' as binary(16))),
       (CAST('7ba15da9-aa65-4b2d-b9c4-8df963250f13' as binary(16)), 'Lina', 'Grenik', '1993-01-25', NULL,
        CAST('963e3e81-1983-4ea8-8ab5-2e0ff0919727' as binary(16))),
